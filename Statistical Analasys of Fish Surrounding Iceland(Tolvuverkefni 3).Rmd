...
## k)
Now we show a box plot of the fish length by age in the quadrant `r rand_quadrant$quadrant[1]` for all the fishes in that quadrant.
...
library("rgeos")
```
After loading the relevant libraries for maps drawing, we can draw Iceland and it's waters, including the fishing spots.
...
ggplot(data = world) +
  geom_sf(color = "black", fill = "#e0e0e0")+ # Black border
